...
public class LetterToNumber {
    public static String convert(String input) {
        ...
        //como que en ingles profe?, I don´t speak english T-T
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LetterToNumber.convert("abc def"));     // "1 2 3 4 5 6"
        System.out.println(LetterToNumber.convert("áéíóú"));       // "1 5 9 15 21"
        System.out.println(LetterToNumber.convert("hello world")); // "8 5 12 12 15 23 15 18 12 4"
        System.out.println(LetterToNumber.convert("a-b c"));       // "1 2 3"
        System.out.println(LetterToNumber.convert(""));            // ""
