 package unidad1;
  ...
  public class Isogram {
    ...
    public static void main(String[] args) {
        System.out.println(Isogram.isIsogram(""));          // false
System.out.println(Isogram.isIsogram("queso"));   // true
System.out.println(Isogram.isIsogram("marco")); // true
System.out.println(Isogram.isIsogram("martillo"));     // false
System.out.println(Isogram.isIsogram("ya no quiero madrugar profe :( ")); // false
